            ...
            <main>
                ...
                <div class="container">
                    <div class="d-flex justify-content-center">
                        <p class="h1 fw-bold p-4 text-white">CREAR APUESTA</p>
                    </div>
                    <div class="container d-flex justify-content-center">
                        <div class="bg-light rounded-4 p-5">
                            <div class="border border-dark rounded-4 p-2">
                                <form action="crear_apuesta2.php" method="POST" class="m-4">
                                    ...
                                    <div class="form-row row d-flex justify-content-center">
                                        <label for="monto" class="d-flex justify-content-center">Monto a Apostar (€):</label>
                                        <div class="form-group col-md-4 mb-4">
                                            <input type="number" id="monto" name="monto" class="form-control" step="0.001" min="0" max="500" required>
                                        </div>
                                    </div>
                                    <div class="form-row row d-flex justify-content-center">
                                        <div class="form-group col-md-6">
                                            <select id="ganador" name="resultado" class="form-control" required>
                                                ...
                                                <option value="1"><?php echo $fila['jugador_visitante'];
                                                                    echo " ---> ";
                                                                    echo $fila_cuota['cuota_visitante']; ?> </option>
                                                <option value="2"><?php echo $fila['jugador_local'];
                                                                    echo " ---> ";
                                                                    echo $fila_cuota['cuota_local']; ?></option>
                                            </select>
                                        </div>
                                    </div>
