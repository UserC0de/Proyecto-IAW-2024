        ...
        <nav class="navbar navbar-expand text-bg-warning fw-bold rounded-4">
          <div class="container-fluid text-uppercase">
            ...
            <ul class="navbar-nav fw-bold">
              ...
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Apuestas en vivo</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Porras</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Casino</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Slots</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Virtuales</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="#">Locales</a>
              </li>
            </ul>
            <ul class="navbar-nav">
              ...
              <li class="nav-item m-auto p-2">
                <button type="button" class="btn btn-light p-2 me-2 fw-bold text-warning">Registrarse</button>
              </li>
            </ul>
        </nav>
      </div>
    ...
    <div class="row mt-3 mx-auto">
      <div class="col-sm-4">
        <div class="card text-white border-light">
          <img src="fotos/card1.png" class="card-img" alt="..." style="max-width: 600px;">
          <div class="card-img-overlay">
            ...
            <button type="button" class="btn btn-info mt-3 mx-5 text-dark p-3">REGISTRARSE</button>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
    ...
    <div class="container p-4">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
          ...
          <p>
            La campiña está autorizado por la Dirección General de Ordenación del Juego
          </p>
